...
struct DirectTests {
    ...
    func testDirectNorthFromEquator() {
        ...
        let result = direct(from: start, distance: 1000.0, azimuth: 0.0)
    ...
    func testDirectEastFromEquator() {
        let start = (lat: 0.0, lon: 0.0)
        let result = direct(from: start, distance: 1000.0, azimuth: 90.0)
    ...
    func testDirectFromNorway() {
        ...
        let result = direct(from: start, distance: 10000.0, azimuth: 45.0)
    ...
    func testDirectZeroDistance() {
        ...
        let result = direct(from: start, distance: 0.0, azimuth: 123.0)
